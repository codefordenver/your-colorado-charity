...
export class DataDemo extends Component {
    ...
    componentDidMount() {
        this.CharityService.getCarsMedium().then(data => this.setState({dataTableValue: data}));
        ...
        this.CharityService.getCarsLarge().then(data => this.setState({dataViewValue: data}));
        this.nodeService.getTreeTableNodes().then(files => this.setState({documents: files}));
        this.CharityService.getCarsMedium().then(data => this.setState({picklistSourceCars: data}));
        this.CharityService.getCarsSmall().then(data => this.setState({orderlistCars: data}));
