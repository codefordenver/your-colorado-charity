...
export class SampleDemo extends Component {
    ...
    componentDidMount(){
        ...
        this.CharityService.getCarsSmall().then(data => this.setState({dataTableValue: data}));
        ...
        this.CharityService.getCarsSmall().then(data => this.setState({picklistSourceCars: data}));
